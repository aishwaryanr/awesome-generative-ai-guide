...
KB = {
    ...
    "store-hours": "Support is available every day from 6 AM to 10 PM in your local time zone.",
}
...
def retrieve(transcript: str, k: int = 2):
    ...
    so an out-of-scope caller retrieves an empty context and the agent hands off to a human.
    """
    q = _content_words(transcript)
    scored = []
